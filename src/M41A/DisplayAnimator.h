...
private:
  ...
  unsigned long lastSegmentUpdateTime; // New variable for segment update timing
...
public:
  ...
  AnimationType getCurrentAnimation() const; // New method to get current animation type
};
